 ...
 * @method void setShippingMethod(string $data)
 * @method float getShippingPrice()
 * @method void setShippingPrice(float $data)
 * @method float getPriceDiscountAdditional()
 * @method void setPriceDiscountAdditional(float $data)
 ...
 *
 */
class SaleOrder extends \Flancer32\Lib\DataObject
{
