...
class InstallSchema_UnitTest extends \Praxigento\Core\Lib\Test\BaseMockeryCase {
    ...
    public function test_constructor() {
        ...
        $this->assertInstanceOf(\Praxigento\Odoo\Setup\InstallSchema::class, $obj);
    }
    ...
    public function test_install() {
        ...
        $mockCoreSchema = $this
            ->getMockBuilder('Praxigento\Odoo\Lib\Setup\Schema')
            ->disableOriginalConstructor()
            ->getMock();
        $mockObm
            ->expects($this->once())
            ->method('get')
            ->with('Praxigento\Odoo\Lib\Setup\Schema')
