...
use Praxigento\Odoo\Api\Web\Customer\Wallet\Balance\Response as AnObject;
    ...
    extends \Praxigento\Core\Test\BaseCase\Unit
{
    public function test_convert()
    {
        ...
        $data = new \Praxigento\Odoo\Api\Web\Customer\Wallet\Balance\Response\Data();
        $data->setBalance(12.32);
