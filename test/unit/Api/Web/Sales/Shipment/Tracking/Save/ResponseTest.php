...
use Praxigento\Odoo\Api\Web\Sales\Shipment\Tracking\Save\Response as AnObject;
    ...
    extends \Praxigento\Core\Test\BaseCase\Unit
{
    ...
    public function test_convert()
    {
        ...
        $data = new \Praxigento\Odoo\Api\Web\Sales\Shipment\Tracking\Save\Response\Data();
        $obj->setData($data);
